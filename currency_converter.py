...
#---------------------------------------------------------------------------------------------------------------
def image():
    print(f"\n+-------------------------------------------------------------------+\n| Do you want to convert your currency to Indian Rupees : Enter [1] |\n| Do you want to convert your currency to U.S. Dollar   : Enter [2] |\n| Do you want to convert your currency to Euro          : Enter [3] |\n| Do you want to convert your currency to Japanese Yen  : Enter [4] |\n| Do you want to convert your currency to British Pound : Enter [5] |\n| Do you want to convert your currency to Chinese Yuan  : Enter [6] |\n| To Exit This Menu                                     : Enter [7] |\n+-------------------------------------------------------------------+\n")
    return
def image1():
